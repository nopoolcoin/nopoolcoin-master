...
const QString BITCOIN_IPC_PREFIX("nopoolcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click nopoolcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start nopoolcoin: click-to-pay handler");
    else
...
{
    // clicking on nopoolcoin: URLs creates FileOpen events on the Mac:
