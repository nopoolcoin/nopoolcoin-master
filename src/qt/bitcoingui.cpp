    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("nopoolcoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About nopoolcoin"), this);
    aboutAction->setStatusTip(tr("Show information about nopoolcoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for nopoolcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your nopoolcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified nopoolcoin addresses"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
	...
	//printf("Debug setMining step 1\n");
        setMining(false, 0);
	//printf("Debug setMining step 2\n");
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("nopoolcoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to nopoolcoin network", "", count));
}
...
{
    QString strTitle = tr("nopoolcoin"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid nopoolcoin address or malformed URI parameters."),
