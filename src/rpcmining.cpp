...
Value getmininginfo(const Array& params, bool fHelp)
{
    ...
    //obj.push_back(Pair("generate",      GetBoolArg("-gen"))); dHashesPerSec
...
Value getblocktemplate(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "nopoolcoin is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "nopoolcoin is downloading blocks...");
